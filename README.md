...
Home places two 44×44 icon controls beside **Today's habits**: one opens habit management in the selected scope and one opens full-screen **Categories**. The category rail no longer ends in a trailing plus. **All** remains a permanent, protected aggregate on Home and in Manage Habits, but it is not shown as an editable category card. Categories shows compact 16px name cards without habit counts; a 250ms long press on the narrow three-dot grip reorders them vertically, while keyboard arrows remain available. Real categories can be created, renamed, assigned a curated icon, and reordered. Opening a category shows every assigned habit, regardless of today’s schedule or completion state. Habits move one at a time from their focused editor, retain their identity and history, and can be reordered only inside their real category.
